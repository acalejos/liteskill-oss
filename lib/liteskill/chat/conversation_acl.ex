defmodule Liteskill.Chat.ConversationAcl do
  @moduledoc """
  Schema for conversation access control entries.
  """
  ...
  def changeset(acl, attrs) do
    acl
    |> cast(attrs, [:conversation_id, :user_id, :group_id, :role])
    ...
    |> unique_constraint([:conversation_id, :group_id],
      name: :conversation_acls_conversation_id_group_id_index
    )
    |> check_constraint(:user_id, name: :user_or_group_required)
